...
use utils::eth_transaction::{EthTransactionImpl, ValidateTxParam};
...
fn test_validate_eip_2930_tx() {
    ...
    let result = EthTransactionImpl::validate_eth_tx(validate_tx_param).expect('signature verification failed');
