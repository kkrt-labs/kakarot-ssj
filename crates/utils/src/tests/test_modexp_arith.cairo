...
fn test_big_sq_5() {
    ...
    check_big_sq(
        0x8e67904953db9a2bf6da64bf8bda866d,
         ref expected);
}
...
fn test_big_sq_6() {
    ...
    check_big_sq(
        0x9f8dc1c3fc0bf50fe75ac3bbc03124c9,
         ref expected);
}
...
fn test_big_sq_7() {
    ...
    check_big_sq(
        0x9c9a17378f3d064e5eaa80eeb3850cd7,
         ref expected);
}
...
fn test_big_sq_8() {
    ...
    check_big_sq(
        0xcf2025cee03025d247ad190e9366d926,
         ref expected);
}
...
#[test]
fn test_big_sq_10( ) {
       let mut x = MPNatTrait::from_big_endian(array![
        ...
        let mut result = MPNat {digits: out};
               ...
               let mut expected = MPNatTrait::from_big_endian(array![
...
fn test_shifted_carrying_mul() {
    ...
    assert_eq!(
        shifted_carrying_mul(WORD_MAX, WORD_MAX, WORD_MAX, WORD_MAX),
        (WORD_MAX, WORD_MAX)
    );
}
