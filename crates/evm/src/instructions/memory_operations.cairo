...
impl MemoryOperationsImpl of MemoryOperationsTrait {
    ...
    fn exec_mload(ref self: ExecutionContext) {
    ...
    fn exec_jump(ref self: ExecutionContext) {}
    ...
    fn exec_jumpi(ref self: ExecutionContext) {}
