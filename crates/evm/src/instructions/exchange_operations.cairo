...
impl ExchangeOperations of ExchangeOperationsTrait {
    ...
    fn exec_swap1(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(1)
    }
    ...
    fn exec_swap2(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(2)
    }
    ...
    fn exec_swap3(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(3)
    }
    ...
    fn exec_swap4(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(4)
    }
    ...
    fn exec_swap5(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(5)
    }
    ...
    fn exec_swap6(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(6)
    }
    ...
    fn exec_swap7(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(7)
    }
    ...
    fn exec_swap8(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(8)
    }
    ...
    fn exec_swap9(ref self: Machine) -> Result<(), Errors> {
        self.stack.swap_i(9)
    }
    ...
    fn exec_swap10(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_swap11(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_swap12(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_swap13(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_swap14(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_swap15(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_swap16(ref self: Machine) -> Result<(), Errors> {
