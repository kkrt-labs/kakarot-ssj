...
impl ComparisonAndBitwiseOperations of ComparisonAndBitwiseOperationsTrait {
    ...
    fn exec_lt(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_gt(ref self: Machine) -> Result<(), Errors> {
        let popped = self.stack.pop_n(2)?;
        let a = *popped[0];
        let b = *popped[1];
        let result = (a > b).into();
    ...
    fn exec_slt(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_sgt(ref self: Machine) -> Result<(), Errors> {
        let a: i256 = self.stack.pop_i256()?;
        let b: i256 = self.stack.pop_i256()?;
        let result: u256 = (a > b).into();
        self.stack.push(result)
    ...
    fn exec_eq(ref self: Machine) -> Result<(), Errors> {
        let popped = self.stack.pop_n(2)?;
        let a = *popped[0];
        let b = *popped[1];
        let result = (a == b).into();
    ...
    fn exec_iszero(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_and(ref self: Machine) -> Result<(), Errors> {
        let popped = self.stack.pop_n(2)?;
        let a = *popped[0];
        let b = *popped[1];
        let result = a & b;
    ...
    fn exec_or(ref self: Machine) -> Result<(), Errors> {
        let popped = self.stack.pop_n(2)?;
        let a = *popped[0];
        let b = *popped[1];
        let result = a | b;
    ...
    fn exec_xor(ref self: Machine) -> Result<(), Errors> {
        let popped = self.stack.pop_n(2)?;
        let a = *popped[0];
        let b = *popped[1];
        let result = a ^ b;
    ...
    fn exec_not(ref self: Machine) -> Result<(), Errors> {
    ...
    fn exec_byte(ref self: Machine) -> Result<(), Errors> {
        let popped = self.stack.pop_n(2)?;
        let i = *popped[0];
        let x = *popped[1];
    ...
    fn exec_shl(ref self: Machine) -> Result<(), Errors> {
        let popped = self.stack.pop_n(2)?;
        let shift = *popped[0];
        let val = *popped[1];
    ...
    fn exec_shr(ref self: Machine) -> Result<(), Errors> {
        let popped = self.stack.pop_n(2)?;
        let shift = *popped[0];
        let value = *popped[1];
    ...
    fn exec_sar(ref self: Machine) -> Result<(), Errors> {
