...
impl InternalMemoryMethods of InternalMemoryTrait {
    ...
    fn store_element(ref self: Memory, element: u256, chunk_index: usize, offset_in_chunk: u32) {
        ...
        let mask_c: u256 = POW_256_16.into() / mask;
    ...
    fn store_aligned_words(ref self: Memory, mut chunk_index: usize, mut elements: Span<u8>) {
        loop {
            ...
            let current: u256 = ((*elements[0]).into() * POW_256_15
                + (*elements[1]).into() * POW_256_14
                + (*elements[2]).into() * POW_256_13
                + (*elements[3]).into() * POW_256_12
                + (*elements[4]).into() * POW_256_11
                + (*elements[5]).into() * POW_256_10
                + (*elements[6]).into() * POW_256_9
                + (*elements[7]).into() * POW_256_8
                + (*elements[8]).into() * POW_256_7
                + (*elements[9]).into() * POW_256_6
                + (*elements[10]).into() * POW_256_5
                + (*elements[11]).into() * POW_256_4
                + (*elements[12]).into() * POW_256_3
                + (*elements[13]).into() * POW_256_2
                + (*elements[14]).into() * POW_256_1
                + (*elements[15]).into() * POW_256_0);
    ...
    fn load_internal(ref self: Memory, offset: usize) -> u256 {
        ...
        let mask: u256 = helpers::pow256_rev(offset_in_chunk);
        let mask_c: u256 = POW_2_128 / mask;
