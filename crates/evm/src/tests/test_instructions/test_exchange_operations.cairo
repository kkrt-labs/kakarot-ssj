...
fn test_exec_swap1() {
    ...
    // given
    machine.stack.push(0xf).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap1().expect('exec_swap1 failed');
...
fn test_exec_swap2() {
    ...
    machine.stack.push(1).expect('push failed');
    machine.exec_swap2().expect('exec_swap2 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be now 0xf');
...
fn test_exec_swap3() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap3().expect('exec_swap3 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be now 0xf');
...
fn test_exec_swap4() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap4().expect('exec_swap4 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap5() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap5().expect('exec_swap5 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap6() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap6().expect('exec_swap6 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap7() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap7().expect('exec_swap7 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap8() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap8().expect('exec_swap8 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap9() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap9().expect('exec_swap9 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap10() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap10().expect('exec_swap10 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap11() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap11().expect('exec_swap11 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap12() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap12().expect('exec_swap12 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap13() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap13().expect('exec_swap13 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap14() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap14().expect('exec_swap14 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap15() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap15().expect('exec_swap15 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
...
fn test_exec_swap16() {
    ...
    machine.stack.push(0).expect('push failed');
    machine.stack.push(1).expect('push failed');
    machine.exec_swap16().expect('exec_swap16 failed');
    assert(machine.stack.peek().unwrap() == 0xf, 'Top should be  now 0xf');
