...
fn test_exec_sha3_size_0_offset_0() {
    ...
    assert(ctx.memory.size() == 32, 'wrong memory size');
}
...
fn test_exec_sha3_size_5_offset_4() {
    ...
    assert(ctx.memory.size() == 64, 'wrong memory size');
}
...
fn test_exec_sha3_size_0xFFFFF_offset_1000() {
    ...
    assert(ctx.memory.size() == (((0xFFFFF + 1000) + 31) / 32) * 32, 'wrong memory size');
}
...
fn test_exec_sha3_size_1000000_offset_2() {
    ...
    assert(ctx.memory.size() == (((1000000 + 2) + 31) / 32) * 32, 'wrong memory size');
}
...
fn test_exec_sha3_size_1000000_offset_23() {
    ...
    assert(ctx.memory.size() == (((1000000 + 23) + 31) / 32) * 32, 'wrong memory size');
}
...
fn test_exec_sha3_size_1_offset_2048() {
    ...
    assert(ctx.memory.size() == (((2048 + 1) + 31) / 32) * 32, 'wrong memory size');
}
...
fn test_exec_sha3_size_0_offset_1024() {
    ...
    assert(ctx.memory.size() == 1024, 'wrong memory size');
}
...
fn test_exec_sha3_size_32_offset_2016() {
    ...
    assert(ctx.memory.size() == (((2016 + 32) + 31) / 32) * 32, 'wrong memory size');
}
...
fn test_exec_sha3_size_0x0C80_offset_0() {
    ...
    assert(ctx.memory.size() == 0x0C80 + 32, 'wrong memory size');
}
