...
//     // Given
//     let mut vm = VMBuilderTrait::new_with_presets().with_bytecode(array![1, 2, 3].span()).build();
...
// fn test_origin() {
//     // Given
//     let mut vm = VMBuilderTrait::new_with_presets().with_nested_vm().build();
